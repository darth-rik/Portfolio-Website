...
import EShopWall from "../../images/e-shop-front.png";
import CountryFinderWall from "../../images/country-finder-bg.png";
      ...
      <div className="container">
        ...
        <div className="projects-container">
          ...
          <div className="project project--4">
            <div className="project__img u-margin-bottom-small">
              <img src={EShopWall} alt="" />
              <p>
                A full-stack e-commerce shopping site. <br />
                The project was built using <strong>ReactJS</strong> ,{" "}
                <strong>Redux</strong> and <strong>Bootstrap</strong> on the
                Front-End and <strong>NodeJS</strong>, <strong>MongoDB</strong>{" "}
                on the Back-End. To deal with payments
                <strong> Stripe-Api</strong> was used.
              </p>
            </div>
            <h2 className="u-margin-bottom-x-small">E-Shop</h2>
            <div className="project__buttons">
              <a
                href="https://eshopp-app.herokuapp.com/"
                target="_blank"
                rel="noreferrer"
              >
                <button className="btn btn--black btn--small">Live Site</button>
              ...
              <a
                href="https://github.com/darth-rik/E-Commerce-Shop"
                target="_blank"
                rel="noreferrer"
              >
                <button className="btn btn--white btn--small">
          ...
          <div className="project project--5">
            <div className="project__img u-margin-bottom-small">
              <img src={CountryFinderWall} alt="" />
              <p>
                A web application to find details about countries. <br />
                The project was built using <strong>ReactJS</strong> ,{" "}
                <strong>Redux</strong>.
              </p>
            </div>
            <h2 className="u-margin-bottom-x-small">Country-Finder</h2>
            <div className="project__buttons">
              <a
                href="https://country-finder-webapp.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                <button className="btn btn--black btn--small">Live Site</button>
              ...
              <a
                href="https://github.com/darth-rik/Country_Finder"
                target="_blank"
                rel="noreferrer"
              >
                <button className="btn btn--white btn--small">
